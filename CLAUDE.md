...
citations/individual/*.bib ──merge_bib.py──▶ publications.bib
                                              ...
                                              └─▶ build_cv.py 논문 섹션
application_info.xlsx ──┬─▶ build_cv.py (13시트) ─▶ Lee_Seunghyeon_CV_v9.docx
...
### CV 재생성
```
cd cv && python build_cv.py            → Lee_Seunghyeon_CV_v9.docx
...
- **`cv/Lee_Seunghyeon_CV_v9.docx` 와 `public/cv/Lee_Seunghyeon_Clay_CV.pdf`** 는
